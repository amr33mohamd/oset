...
@font-face {
  ...
  src: url('/fonts/diodrum-arabic-medium.ttf');
}
body{
  color: #000;
  font-family: myFirstFont;
...
">
      <div class="container">
  <a class="navbar-brand" href="#"><img src="/images/500px (1).png" style="height:70px"/></a>
  ...
  <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
    <ul class="navbar-nav ">
      <li class="nav-item active">
        <a class="nav-link" href="#">عن الشركه </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#services">كيف تستخدم المنصه؟</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#aboutus">الخدمات</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#" data-toggle="modal" data-target="#exampleModal">قدم طلبك</a>
      </li>
      <li class="nav-item">
...
<div class="container-fluid">
  ...
  <!-- start -->
  <div class="row d-flex " style="background:url('/images/Page 1 AR.png');background-size:cover;background-repeat: no-repeat;height:700px">
    <div class="container align-middle justify-content-center align-self-center">
    <div class="col-lg-6 col-sm-12 " >
      <h1 style="font-weight:100;color:#fff;font-size:60px" >وثقها مع <span style="font-weight:100;color:#0e2722;font-size:60px">وثقها </span></h1>

    </div>
    <div class="col-lg-4 col-sm-12 " >

    <h7 >منصه الكترونيه سهله الاستخدام تساعد الموردين عل الحصول علي شهادات المطابقه للمنتجات و خدمات الجوده و التسجيل في سابر .. <span style="color:#fff"> و اكثر</span></h7>
</div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">طلب</h5>
          ...
          <div class="row"  id="form">
            <div class="col-lg-12 col-sm-12">
              <form action="/add-designer" enctype="multipart/form-data" method="post">
                ...
                <div class="form-group">
                  <label for="exampleInputPassword1">بريد الالكتروني</label>
                  <input type="email" name="email" class="form-control" id="exampleInputPassword1">
                  <small id="emailHelp" class="form-text text-muted">لا نشارك بريدك الالكتروني مع اي شخص</small>
        ...
        <div class="modal-footer">
          ...
          <button class="btn " style="background-color:#2aa184;color:#efefef" type="submit">تقديم الان</button>
        </form>
...
<div class="container">
<div  style="background:#efefef;border-radius:20px;margin-top:-50px;height:100px;padding:20px" class="col-lg-5 col-10 text-center">
...
<div class="services" style="padding-top:100px">
  ...
  <div class="row">
    ...
    <div class="col-lg-6 col-12 row d-flex" style="padding:20px;cursor:pointer" data-toggle="modal" data-target="#exampleModal" >
      ...
      <div class="col-8 text-left">
        <p style="  margin: auto;padding: 10px;" class="text-right">إرسال بياناتك و قم برفع ملفاتك و طلبك بدون تسجيل  <a style="color:red">من هنا</a></p>
      </div>
    </div>

    <div class="col-lg-6 col-12 row d-flex" style="padding:20px">
      <div class="col-lg-2 col-4">
      ...
      <div class="col-8 text-left">
        <p style="  margin: auto;padding: 10px;" class="text-right">تقوم منصه وثقها بمراجعه طلبك من ثم الموافقه عليه و تحديد ميزانيه التوثيق</p>
      </div>
    </div>
  </div>
  ...
  <div class="row ">
    ...
    <div class="col-12 col-lg-6 row d-flex" style="padding:20px">
      ...
      <div class="col-8 text-left">
        <p style="  margin: auto;padding: 10px;" class="text-right">تقوم بايداع المبلغ المطلوب أون لاين من خلال البطاقات الإتمانيه أو سداد</p>
      </div>
    </div>
    <div class="col-12 col-lg-6 row d-flex" style="padding:20px">
      <div class="col-lg-2 col-4">
      ...
      <div class="col-8 text-left">
        <p style="  margin: auto;padding: 10px;" class="text-right">نقوم بالعمل علي انهاء جميع مهامك بنسبه ١٠٠٪ و من ثم ارسالها لك</p>
      </div>
    </div>
  </div>
